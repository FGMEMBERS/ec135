...
var checkGandVNE = func {
  ...
  #var TOP =getprop("/sim/model/ec135/torque-pct");
  #var MTOP = getprop("limits/MTOP");
  
  #if (TOP > MTOP)
  #{
  #msg = "Maximum Takeoff Power exceeds 75% Torque! Only allowed for 5min!";
  #}
  
#Now Check MaximumContinousPower
  #var P =getprop("/sim/model/ec135/torque-pct");
  #var MCP = getprop("limits/MCP");
  #if (P > MCP) 
  #{
 # msg = "Maximum Maximum Continous Power exceeds 69% Torque! ";
 # }
